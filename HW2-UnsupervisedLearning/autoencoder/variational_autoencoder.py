...
class VariationalAutoencoder(BasePLModule):    
    ...
    def __init__(self, 
        ...
        super(VariationalAutoencoder, self).__init__(optimizer     = optimizer, 
...
class VariationalAutoencoderHPS(BaseHPS):
    """ 
    Class that receives in input the hyper-parameters space as a dict and provide a sampling function to be
    used within a Optuna study. This class is for the VariationalAutoencoder model.
    """        
    def __init__(self, hp_space):
        
        super().__init__(hp_space)
        self.model_class = VariationalAutoencoder
